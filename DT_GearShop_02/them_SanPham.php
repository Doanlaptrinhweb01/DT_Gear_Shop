<?php
	...
	$sql = "select MaSanPham from sanpham where SoLuongTon >0 and BiXoa = 0 and MaSanPham=".$id; //viết câu truy vấn kiểm tra mã sản phẩm tồn tại
	...
	{
		header("location:index.php");	//nhảy tới trang in dex
	}
?>