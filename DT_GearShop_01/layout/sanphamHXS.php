<div class="sanpham">
	<?php
		...
		$sql = "SELECT TenSanPham,MaSanPham, HinhURL, GiaSanPham, TenHangSanXuat FROM sanpham, hangsanxuat WHERE sanpham.MaHangSanXuat = hangsanxuat.MaHangSanXuat
