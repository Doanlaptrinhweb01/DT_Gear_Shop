    	...
    	<div class="frmDangKy">
            ...
            <?php
				...
				if(isset($_POST['btnDangKy']))
				{
					...
					if(empty($tenDangNhap) || empty($matKhau) || empty($tenHienThi) || empty($diaChi) || empty($dienThoai) || empty($email))
					{
					...
					{
						$err = "<p style='color:red'>Xác nhận mật khẩu không đúng</p>";
					}
            ...
            <form method="post">
                ...
                <div>
                	...
                	<label>
                    	<input type="number" id="txtDienThoai" name="txtDienThoai" placeholder="0123456789" value="<?php echo $dienThoai ?>" size="32" />
                    </label>
                </div>
