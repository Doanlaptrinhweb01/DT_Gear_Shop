<div class="sanpham">
	<?php
		...
		$sql = "SELECT MaSanPham ,TenSanPham, HinhURL, GiaSanPham, TenHangSanXuat FROM sanpham, hangsanxuat WHERE sanpham.BiXoa=0 AND sanpham.MaHangSanXuat = hangsanxuat.MaHangSanXuat
