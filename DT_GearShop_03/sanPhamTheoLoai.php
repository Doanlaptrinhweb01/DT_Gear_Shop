<div class="sanpham">
	<?php
		...
		$sql = "SELECT MaSanPham ,TenSanPham, HinhURL, GiaSanPham, TenLoaiSanPham FROM sanpham, loaisanpham WHERE sanpham.BiXoa=0 AND sanpham.MaLoaiSanPham = loaisanpham.MaLoaiSanPham
